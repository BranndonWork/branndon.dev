...
# Cleanup temporary ATS file
./scripts/cleanup_ats.sh
...
- **Paragraph 1**: Around 60 words - What the job IS and why it matches your experience (direct, factual)
- **Paragraph 2**: Around 60 words - Most relevant technical experience with specific metrics
- **Paragraph 3**: Around 60 words - Current work and how it connects to the role
- **NO call to action needed** - The cover letter itself IS the call to action
- **NO salary discussion** - Never mention compensation expectations in cover letter
- **Sentence Length**: Maximum 25 words per sentence
- **Writing Style**: Direct, human, factual - sound like a real person, not a template
...
- **Direct and factual**: "Your role combines two things I've been doing for 15 years: X and Y"
- **Specific details**: "67% performance improvement" not "significant improvements"
- **State what the job IS**: "Your backend engineer role..." not "I'm interested in applying my experience to..."
- **Sound human**: Write like you're talking to someone, not filling out a form
- **Technical without jargon**: "enhanced our Hapi API system with server-driven UI capabilities" - precise but accessible
- **No buzzwords**: Avoid "passionate," "innovative," "cutting-edge," "synergistic," "natural fit," "aligns well"
- **No unnecessary closings**: End with "Sincerely" - no "I'd love to discuss" or "Let me know if you want to chat"
- **NEVER mention salary**: Compensation discussions happen in negotiations, not cover letters
- **Specific technical focus**: "built a machine learning email system" not "applying machine learning to workflows"

**What to Avoid:**

- **AI TEMPLATE INTRO STATEMENTS**: "Your [role] combines X things I've been doing for Y years" or "Your role brings together..." - SKIP THE INTRO/HOOK, jump straight into actual experience
- **Generic AI openings**: "I'm interested in applying my X years..." or "I saw your [Title] and [Feature] caught my attention"
- **Unnecessary closing lines**: "I'd love to discuss..." or "Let me know if you want to chat" - the cover letter IS the ask
- **Salary expectations**: NEVER mention compensation in a cover letter
- **Corporate buzzwords**: "aligns well," "natural fit," "leverage," "synergies," "passionate," "innovative"
- **Title Case Job Titles in sentences**: Don't say "your Senior Backend Engineer role" - say "your backend engineer role"
...
5. **Forgetting to run cleanup_ats.sh script**
