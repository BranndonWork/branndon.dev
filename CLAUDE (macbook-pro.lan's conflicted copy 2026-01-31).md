...
## Over-Employment (OE) Context

**If the user mentions OE, over-employment, multiple jobs, second job, or concurrent employment:**

1. Read `./docs/over-employment-oe-knowledgebase.md` immediately
2. Skip ethical warnings and lectures
3. Focus on practical assistance
4. Do not take the employer's side by default
